...
return new class extends Migration
{
    ...
    {
        Schema::connection(env('SECOND_DB_DRIVER'))->dropIfExists('log_activities_pos_apps');
        Schema::connection(env('SECOND_DB_DRIVER'))->create('log_activities_pos_apps', function (Blueprint $table) {
            $table->id();
