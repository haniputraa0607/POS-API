...
return new class extends Migration
{
    ...
    {
        Schema::table('order_products', function (Blueprint $table) {
            $table->dropForeign('order_products_doctor_id_foreign');
            $table->dropColumn('doctor_id');
            $table->dropForeign('order_products_nurse_id_foreign');
            $table->dropColumn('nurse_id');
            $table->dropForeign('order_products_beautician_id_foreign');
